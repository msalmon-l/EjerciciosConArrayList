...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        rotar(alumnos, alumnos.size());
        System.out.println("rotamos: ");
        System.out.println(alumnos);
    }

    public static void rotar(ArrayList<Double> list, double size) {
        int i = 0;
        int mitad = (int)size / 2;

        while(i < mitad) {
             double cambiable = list.get(i);
            System.out.println(i);
             list.set(i, list.get((int)size - i - 1));

             list.set((int)size - i - 1, cambiable);
         //   System.out.println(i);
             i++;
